		...
		<div class="align-center" id="right-options">
			<div class="dg-box">
					...
					<?php if ($product != false) { ?>
						<div class="content-y">									
							...
							<div class="product-info" id="product-attributes">
								<div id="digitisation"><label><input type="checkbox" name="digitisation" checked> Digitisation</label></div>
				...
				<div class="product-prices">
					...
					<div id="antondrob-prices">
						<div id="antondrob-product-price">
							<p class="label label-default">Product price: <?php echo $settings->currency_symbol; ?><span class="price-product-number">0</span></p>
						</div>
						<div id="antondrob-cust-price">
							<p class="label label-default">Customisation price: <?php echo $settings->currency_symbol; ?><span class="price-cust-number">0</span></p>
						</div>
						<div id="antondrob-price-extra">
							<p class="label label-default">Digitisation: <?php echo $settings->currency_symbol; ?><span class="digitisation">0</span></p>
						</div>
					</div>
