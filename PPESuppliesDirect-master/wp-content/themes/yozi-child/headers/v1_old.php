                    ...
                    <div class="header-middle">
                        <div class="row">
                            <div class="table-visiable-dk">
								...
								<div class="col-md-12">
									<div class="header-right clearfix" style="margin-top: 10px; margin-bottom:7px;">
                                    ...
                                    <div class="vat-switcher">
                                         ...
                                         <span class="input">
                                            ...
                                            type="checkbox" 
                                            id="switch" 
                                            value="<?php echo explode( '?',  "https://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]" )[0] . $cont . "vat=$tax"; ?>"
                                            <?php if( $_SESSION['vat'] === 'in' ) echo ' checked'; ?>
                                            />
