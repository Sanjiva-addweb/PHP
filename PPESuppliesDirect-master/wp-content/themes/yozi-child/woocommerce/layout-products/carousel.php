...
<div class="slick-carousel slick-carousel-top products <?php echo esc_attr($products); ?>" data-carousel="slick" data-items="<?php echo esc_attr($columns); ?>"
    ...
    <?php echo trim(($columns <= 2 && !empty($show_smalldestop) && ($product_item == 'inner-deal') ) ? 'data-smalldesktop="2" data-medium="2" ' : ''); ?>
    <?php echo trim(($columns <= 2 &&  empty($show_smalldestop) && ($product_item == 'inner-deal') ) ? ' data-medium="2" ' : ''); ?>
