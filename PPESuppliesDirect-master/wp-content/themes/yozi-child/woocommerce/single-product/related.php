...
$show_product_releated = yozi_get_config('show_product_releated', true);
...
$per_page = yozi_get_config('number_product_releated', 4);
...
$woocommerce_loop['columns'] = yozi_get_config('releated_product_columns', 4);
if ( $products->have_posts() ) : ?>
	<div class="col-sm-10 col-xs-12 related products widget ">
