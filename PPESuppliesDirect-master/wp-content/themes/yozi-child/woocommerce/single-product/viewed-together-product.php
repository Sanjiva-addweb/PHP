...
$item_style = 'inner';
$rows = 1;
$columns =  yozi_get_config('viewed_product_columns', 8);

$per_page = yozi_get_config('number_product_viewed', 8);
...
if ( $products->have_posts() ) : ?>
	...
	<div class="col-sm-12 col-xs-12 viewedproducts products widget">
