...
$item_style = 'inner';
$rows = 1;
$columns = 8;//yozi_get_config('bought_product_columns', 4);
$per_page = 8;// yozi_get_config('number_product_bought', 4);
...
if ( $products->have_posts() ) : ?>
	...
	<div class="col-sm-10 col-xs-12 boughtproducts products widget">
