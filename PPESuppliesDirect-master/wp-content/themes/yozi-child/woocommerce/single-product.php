...
<section id="main-container" class="layout-detail-product <?php echo apply_filters('yozi_woocommerce_content_class', 'container');?>">
		...
		<div id="main-content" class="archive-shop col-xs-12 <?php echo esc_attr($sidebar_configs['main']['class']); ?>">
			...
			<?php
				//if ( function_exists('yoast_breadcrumb') ) {
			  	//	yoast_breadcrumb( '<div id="breadcrumbs" style="margin-left:10px;">','</div>' );
				//}
			?>
