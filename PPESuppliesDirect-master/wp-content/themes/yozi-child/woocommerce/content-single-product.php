				...
				<div class="information">
					...
					if( $product->is_type( 'simple' ) ){
						...
						if( get_post_meta( $product->get_id(), 'customize_product', true ) ){
							echo '<div class="second_content"><a class="customize_icon" href="'.$homeurl.'/custom-design/?product_id='.$product->get_id().'"><img src="/wp-content/uploads/2019/03/Customise-button.jpg" width="260"></a></div>';
						}
						...
						<div class="after-tab-block"><a id="order_more">Ordering more than 500 items? Give us a call for quote.</a></div>
