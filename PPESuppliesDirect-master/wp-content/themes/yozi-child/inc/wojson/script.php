...
<section id="main-container" class=" inner">
	<div class="row">
		...
		//echo '<pre>' . var_export( array_slice( array_unique( $diffjkl ),2 ), true) . '</pre>';
			...
			$xaa = viv_make_logic_work('T184',$descphp,$techlogicdata);
		...
		/*
				// Register uploaded images to wordpress database
			  	...
			  	$file_dir =  $upload_dir['basedir'] . '/products-images/F440';
				  ...
				  // get the image file
				  $file = $upload_dir['basedir'] . '/products-images/F440/' . $images;
		...
		**/
	    ...
	    $product =  new WC_Product_Variable(119669);
...
/*
	     ...
	     $attribute->set_options(array('XL','L','XXL'));
