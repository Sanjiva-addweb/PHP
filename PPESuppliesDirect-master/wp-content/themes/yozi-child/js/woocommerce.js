(function($) {
    ...
    var yoziWoo = {
        ...
        quickviewInit: function(){
            $('body').on('click', 'a.quickview', function (e) {
                ...
                var url = yozi_woo_options.ajaxurl + '?action=yozi_quickview_product&product_id=' + product_id;
    ...
    var yoziAccessories = {
        ...
        change_event: function() {
            ...
            $.ajax({
                ...
                async: false,
                url: yozi_ajax.ajaxurl,
                data: { 'action': "yozi_get_total_price", 'data': total_price  },
                success : function( response ) {
	...
	/*$(".product-block").hover(function() {
		...
		$("#productinfopopup").hide();
	});*/
	    

})(jQuery)
	
	jQuery("body").on('mousemove','.product-block',function (e) {
		jQuery('.popoverlay').hide();
		var widthdiff = parseInt(jQuery(window).width()) - parseInt(e.pageX);

		var x = e.clientX;
		
		var y = e.clientY;
var heightdiff = parseInt(jQuery(window).height()) - parseInt(e.clientY);
		var newposX = x + 10;
		var newposY = y + 10; 
...
//jQuery('.popoverlay', this).css({"left":""+newposX+"px","top":""+newposY+"px","display":"block"});
var boxhtml = jQuery('.popoverlay', this).html();
jQuery('.popoverlay2').html(boxhtml);
jQuery('.popoverlay2').css({"left":""+newposX+"px","top":""+newposY+"px","display":"block"});
		
		//jQuery('.popoverlay', this).css({"transform":"translate3d("+newposX+"px,"+newposY+"px,0px)","display":"block"});
		
	});
jQuery("body").on('mouseout','.product-block',function (e) {
  jQuery('.popoverlay2').css('display','none');
});
