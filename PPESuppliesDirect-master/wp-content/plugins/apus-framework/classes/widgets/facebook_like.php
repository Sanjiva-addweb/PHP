...
class ApusFramework_Facebook_Like_Box extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_facebook_like',
            esc_html__('Apus Facebook Like Box', 'apus-framework'),
            array( 'description' => esc_html__( 'Adds support for Facebook Like Box. ', 'apus-framework' ), )
        );
...
register_widget( 'ApusFramework_Facebook_Like_Box' );