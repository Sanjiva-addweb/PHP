...
class ApusFramework_Twitter_Widget extends Apus_Widget{

    public function __construct() {
         parent::__construct(
            'apus_twitter_widget',
            esc_html__('Apus Latest Twitter', 'apus-framework'),
            array( 'description' => esc_html__( 'Latest Twitter widget.', 'apus-framework' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $defaults = array(
            'title' => esc_html__('Latest tweets.', 'apus-framework'),
            'user' => 'envato',
        ...
        $values = array(
            1 => esc_html__('Yes', 'apus-framework'),
            0 => esc_html__('No', 'apus-framework'),
        );              
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'user' )); ?>"><?php esc_html_e('Twitter Username:', 'apus-framework'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'limit' )); ?>"><?php esc_html_e('Limit:', 'apus-framework'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'twitter_id' )); ?>"><?php esc_html_e('Twitter Id:', 'apus-framework'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'border_color' )); ?>"><?php esc_html_e('Border Color:', 'apus-framework'); ?></label>
             <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'link_color' )); ?>"><?php esc_html_e('Link Color:', 'apus-framework'); ?></label>
             <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'text_color' )); ?>"><?php esc_html_e('Text Color:', 'apus-framework'); ?></label>
             <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'name_color' )); ?>"><?php esc_html_e('Name Color:', 'apus-framework'); ?></label>
             <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'transparent' )); ?>"><?php esc_html_e('Show background', 'apus-framework'); ?></label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'show_replies' )); ?>"><?php esc_html_e('Show Replies', 'apus-framework'); ?></label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'show_header' )); ?>"><?php esc_html_e('Show Header', 'apus-framework'); ?></label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'show_footer' )); ?>"><?php esc_html_e('Show Footer', 'apus-framework'); ?></label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'show_border' )); ?>"><?php esc_html_e('Show Border', 'apus-framework'); ?></label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'show_scrollbar' )); ?>"><?php esc_html_e('Show Scrollbar', 'apus-framework'); ?></label>
            <br>
...
register_widget( 'ApusFramework_Twitter_Widget' );
