...
if ( !class_exists('Wcap_Email_Template_List' ) ) {
    ...
    class Wcap_Email_Template_List{
        ...
        public static function wcap_save_email_template ( ) {
            ...
            $insert_template_successfuly_pro = Wcap_Email_Template_List::wcap_insert_template_data( $active_post, $coupon_code_id, $unique_coupon, $is_wc_template, $selected_template_filter, $product_ids );
         ...
         * @since 5.0
         */
        public static function wcap_insert_template_data ( $active_post, $coupon_code_id, $unique_coupon, $is_wc_template, $selected_template_filter, $product_ids ) {
            ...
            $query = "INSERT INTO `". WCAP_EMAIL_TEMPLATE_TABLE ."` ( subject, body, is_active, frequency, day_or_hour, coupon_code, template_name, default_template, discount, generate_unique_coupon_code, is_wc_template, wc_email_header, wc_template_filter, cart_rules, product_ids, send_emails_to, activated_time )
                              VALUES (
        ...
        public static function wcap_update_email_template ( ) {
            ...
            if ( isset( $_POST['coupon_ids'] ) ) {
                ...
                $update_template_successfuly_pro = Wcap_Email_Template_List::wcap_update_template ( $unique_coupon, $is_wc_template, $selected_template_filter, $coupon_code_id, $product_ids );
         ...
         * @since 5.0
         */
        public static function wcap_update_template ( $unique_coupon, $is_wc_template, $selected_template_filter, $coupon_code_id, $product_ids ) {
            global $woocommerce, $wpdb;
            ...
            $send_emails[ 'others' ] = ( 'wcap_email_others' == $send_emails[ 'action' ] && '' != $_POST['wcap_other_emails'] ) ? trim( implode( ',', explode( PHP_EOL, $_POST[ 'wcap_other_emails' ] ) ) ) : '';
