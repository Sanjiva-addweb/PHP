        	    ...
        	    <tr>
            	    <td>
                        ...
                        <?php if ( $woocommerce->version >= '3.0' ) { ?>
                            <select style="width:80%" multiple="multiple" class="wcap_page_select wc-product-search" name="wcap_page_select[]" data-placeholder='<?php esc_attr__( 'Search for a Page&hellip;', 'woocommerce-ac' )?>' data-action='wcap_json_find_pages'>
