...
//                add_action( 'woocommerce_cart_updated',                array( 'Wcap_Cart_Updated',   'wcap_store_cart_timestamp' ), 100 );
                add_action( 'woocommerce_add_to_cart',                array( 'Wcap_Cart_Updated',   'wcap_store_cart_timestamp' ), 100 );
            ...
            if( class_exists( 'Wcap_Load_Scripts' ) ) {
                ...
                add_action( 'wp_enqueue_scripts',                      array( 'Wcap_Load_Scripts',   'wcap_enqueue_scripts_atc_modal' ), PHP_INT_MAX );
