...
{	
	...
	else
	{
		...
		$added_text = sprintf( _n( 'Your order has been added to the cart.', 'Your order has been added to the cart.', '', 'woocommerce' ), '' );
		...
		$html .= '<script type="text/javascript">var urlDesignload = "'.$url.'"; var urlBack = "'.get_permalink($product_id).'"; var antondrob_e_update_cart_item = "'.$update_item.'";</script>';
