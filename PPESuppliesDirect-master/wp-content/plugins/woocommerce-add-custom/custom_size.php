...
<div class="table_tab500" >
	...
	<?php 
		if( $tax === 'in' ){
			if( $bulk_price = get_post_meta( $product->get_id(), '_bulkprice', true ) ) {
				$singlep =  $bulk_price * 1.2;
				$price10 =  $bulk_price * 1.2;
				$price20 =  $bulk_price * 1.2;
				$price50 =  $bulk_price * 1.2;
				$price100 = $bulk_price * 1.2;
				$price250 = $bulk_price * 1.2;
			}else {
...
<div class="btn-containerdiv" style="width:38%; float:right;">
		...
		<input type="hidden" value="<?php echo $singlep; ?>" class="product_price1"/>
		<input type="hidden" value="<?php echo $price10; ?>" class="product_price2"/>
		<input type="hidden" value="<?php echo $price20; ?>" class="product_price3"/>
		<input type="hidden" value="<?php echo $price50; ?>" class="product_price4"/>
		<input type="hidden" value="<?php echo $price100; ?>" class="product_price5"/>
		<input type="hidden" value="<?php echo $price250; ?>" class="product_price6"/>
