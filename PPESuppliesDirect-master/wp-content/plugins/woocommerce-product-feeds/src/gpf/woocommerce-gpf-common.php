	...
	public function initialise() {
		...
		$this->product_fields = apply_filters(
			...
			array(
				...
				'purchase_quantity_limit'             => array(
					'desc'            => __( 'Purchase quantity limit', 'woocommerce_gpf' ),
					'full_desc'       => __( 'The limit on the number of items your customers can buy in a single order

 [for Shopping Actions integration]', 'woocommerce_gpf' ),
					'can_default'     => true,
					'callback'        => 'render_textfield',
					'can_prepopulate' => true,
					'feed_types'      => array( 'google' ),
