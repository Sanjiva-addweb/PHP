	...
	*/
	function getPriceAttributes($attributes, $fields, $quantity)
	{
		...
		if (is_string($attributes->titles))
			$titles 	= $wc_attributes; //[["1XL", "2XL", "3XL", "4XL", "5XL", "6XL", "7XL", "8XL", "9XL", "10XL"]]; //json_decode($attributes->titles);
		else
			$titles 	= $wc_attributes; //[["1XL", "2XL", "3XL", "4XL", "5XL", "6XL", "7XL", "8XL", "9XL", "10XL"]]; //$attributes->titles;	
